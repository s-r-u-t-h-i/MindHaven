  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.booksHeader}>
        <Text style={styles.booksTitle}>Your Diagnosis History </Text>
      </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Ionicons name="medkit-outline" size={50} color={COLORS.textSecondary} />
            <Text style={styles.emptyText}>No diagnosis yet</Text>
            <TouchableOpacity style={styles.addButton} onPress={() => router.push("/create")}>
              <Text style={styles.addButtonText}>Add Your First Diagnosis</Text>
            </TouchableOpacity>
          </View>
        }
      />
